 ...
 * node, followed by the name of the metric. IPv4 addresses are represented as the decimal
 ...
 *
 * <pre>
 * // Retrieve the `retries` metric for node 127.0.0.1:9042 in session `s0`:
 * Meter retriesMeter = session.getMetricRegistry().meter("s0.nodes.127_0_0_1_9042.retries");
 *
 * // Retrieve the `retries` metric for node ::1:9042 in session `s0`:
 * Meter retriesMeter = session.getMetricRegistry().meter("s0.nodes.0:0:0:0:0:0:0:1_9042.retries");
 * </pre>
 *
